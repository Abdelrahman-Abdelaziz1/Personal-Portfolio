    ...
    <section id="about" className="w-full py-27 bg-muted/40">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Hi, I'm Abdelrahman - a Data Science student with a passion for web
            development. I build modern, user-friendly applications. Here's a
            look at the technologies I work with.
          </motion.p>
        </div>
